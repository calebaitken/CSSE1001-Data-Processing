...
class LoadDataTests(A2TestClass):
    ...
    def testProcessing(self):
        ...
        eventProcessing.process()
        for athlete in entities.all_events.find_item("Men's Speedskating 5000m").get_athletes():
            print(athlete.get_full_name(), athlete.get_result(entities.all_events.find_item("Men's Speedskating 5000m")), athlete.get_result(entities.all_events.find_item("Men's Speedskating 5000m")).get_place())
            print([entities.all_athletes.find_item("60"),
